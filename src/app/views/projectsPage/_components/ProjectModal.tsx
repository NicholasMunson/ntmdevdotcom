...
export default function ProjectModal({ project, onClose }: ProjectModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-900 rounded-xl max-w-2xl w-full h-[80vh] mt-24 overflow-y-auto">
        <div className="p-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                {project.detailedInfo?.description}
              </p>
            </div>

            {project.detailedInfo?.technologies && (
              <div>
